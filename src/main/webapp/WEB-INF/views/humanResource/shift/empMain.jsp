						...
						<div class="col-lg-12"><!-- <div class="col-lg-12"> -->
							...
							<div class="card shadow mb-12">
								<div class="card-header py-12">
									<div class="row">
										<div class="col-md-2">
										<c:url var="getAllScheduleIncAllById" value="getAllScheduleIncAllById.do">
											<c:param name="empId" value="${sessionScope.emp.id}"></c:param>
										</c:url>
											<a href="${getAllScheduleIncAllById}"><span class="text-danger">* SHOW ALL</span></a>
										</div>
											...
											<div class="card-body">
												<div class="row no-gutters align-items-center">
													...
													<div class="col mr-2">
														...
														<div class="text-s font-weight-bold text-success text-uppercase mb-1 sDateClass">${list[i].sDate}</div>
