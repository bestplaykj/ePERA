			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">Accounting - Revenue</h1>
					</div>
						...
						<div class="col-lg-12"><!-- <div class="col-lg-12"> -->
							...
							<div class="card shadow mb-12">
								<div class="card-header py-12">
									<div class="row">
										<div class="col-md-2">
											<a href="#createRevModal" data-toggle="modal" data-target="#createRevModal">+ Add Income</a>
										</div>
							...
							<c:when test="${fn:length(list) ne 0}">
								<c:forEach var="i" begin="0" end="${fn:length(list)-1}" step="1">
													<tr>
														...
														<td>${list[i].month}</td>
														<td>${list[i].iDate}</td>
														<td><fmt:formatNumber value="${list[i].income}" pattern="#,###" /></td>
													<c:url var="delete" value="deleteRev.do">
														<c:param name="no" value="${list[i].no}" />
													</c:url>
													<c:if test="${list[i].note eq null}">
														<td>-</td>
													</c:if>
													<c:if test="${list[i].note ne null}">
														<td>${list[i].note}</td>
													</c:if>
							...
							<c:otherwise>
													<tr>
														<td colspan="7" class="text-center">매출내역이 없습니다</td>
													</tr>
							</c:otherwise>
							</c:choose>
												</tbody>
												<tfoot>
													<tr>
														<td colspan="4" class="text-center font-weight-bold text-primary">TOTAL</td>
...
<%-- /////////////////////////////////////////////// CreateExp Modal /////////////////////////////////////////////// --%>
	<div class="modal fade" id="createRevModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="createRev.do" method="post" role="form">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-2"></div>
						<div class="col-md-8">
							<input type="date" name="iDate" class="form-control form-control-user" required="required"><br>
							<input type="number" name="income" class="form-control form-control-user" required="required" placeholder="1000000"><br>
							<input type="text" name="note" class="form-control form-control-user" placeholder="note">
						</div>
						<div class="col-md-2"></div>
					</div>
				</div>
...
<%-- /////////////////////////////////////////////// Script /////////////////////////////////////////////// --%>
	<script src="${contextPath}/resources/js/accounting/revenue/main.js"></script>
	<script src="${contextPath}/resources/js/accounting/revenue/mainSel.js"></script>
<%-- /////////////////////////////////////////////// /Script /////////////////////////////////////////////// --%>
